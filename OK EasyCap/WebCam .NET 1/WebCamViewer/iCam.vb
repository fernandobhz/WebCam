...
#End Region
    ...
    Public Sub resetCam()
        ...
        If iRunning Then
            ...
            If setCam() = False Then
                MessageBox.Show("Erro definindo/Redefinindo a WebCam")
            End If
        End If
    ...
    Private Function setCam() As Boolean
        ...
        Dim ret As Integer = SendMessage(hHwnd, WM_CAP_DRIVER_CONNECT, CShort(iDevice), CType(0, String))
    ...
    Public Function copyFrame(ByVal src As PictureBox, ByVal rect As RectangleF) As Bitmap
        If iRunning Then
            ...
            srcMem.Dispose()
        Else
            MessageBox.Show("WebCam não esta em execução!")
        End If
    End Function
